...
const NewOrderForm = () => {
    ...
    function onSubmit(formData: FormData) {
        actions.registerNewOrder(formData).finally(() => ref.current?.reset())
    }
        ...
        <>
            ...
            <form action={onSubmit} ref={ref}>
                ...
                <div className="grid gap-2 py-4">
                    <div className={'mb-4'}>
                        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">New Order</h3>
                    </div>
                    ...
                    <div className={'mb-4'}>
                        ...
                        <div className={'my-2 flex gap-2'}>
                            ...
                            <div className={'flex flex-col'}>
                                <Label className={'mb-2'} htmlFor="new_costumer">Create Costumer</Label>
                                <Button type={'button'} variant={'outline'} id="new_costumer" name={'new_costumer'}>New
                                    Costumer</Button>
                            </div>
                        ...
                        <div className={''}>
                            ...
                            <Textarea id={'note'} name={'note'} placeholder="Type your note here."/>
